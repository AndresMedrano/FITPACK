                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-red active"><i class="mdi-action-account-circle"></i> Clientes</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="registro-clientes.php">Registrar</a></li>
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">ALIADOS</h5>
                <ol class="breadcrumbs">
                    <li><a href="clientes.php"></a>Aliados</li>
                    <li class="active">Registrar Aliado</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="card-panel">
            <div class="row">
              <div class="col s12">
                  <form name="frmclientes" method="POST" action="carga-registro-aliados.php" enctype="multipart/form-data" onsubmit="return validar()">
                  <h5><font color="#b71c1c">Datos del Aliado</font></h5>  
                  <div class="input-field col s6">
                    <label class="active" for="Nombres">Nombres</label>
                    <input id="icon_prefix" type="text" name="txtnombre" required="required" maxlength="60" class="validate" pattern="[a-zA-Z]*">
                  </div>
                  <div class="input-field col s6">
                    <label>Apellidos</label>
                    <input type="text" name="txtapellidos" required="required" maxlength="60" class="validate" pattern="[a-zA-Z]*">
                  </div>
                  <div class="input-field col s6">
                    <label>Nick del Aliado</label>
                    <input type="text" name="txtnick" required="required" class="validate">
                  </div>
                  <div class="input-field col s6">
                    <label>Correo</label> 
                  ...
                  <div class="input-field col s6">
                    ...
                    <input type="tel" name="txttelefonofijo" required="required" class="validate" pattern="[0-9]{7}">
                  </div>
                  <div class="input-field col s6">
                    <label>Teléfono Celular</label>
                    <input type="tel" name="txttelefonocelular" required="required" class="validate" pattern="[0-9]{10}">
                  </div>
                  <div class="input-field col s6">
                    <label>Local</label>
                    <input type="text" name="txtlocal" required="required" maxlength="40" class="validate" >
                  </div>
                  <div class="col s6">
                    <div class="file-field input-field">
                      <div class="btn">
                        <span>Logo Aliado</span>
                        <input type="file" name="logo">
                      </div>
                      <div class="file-path-wrapper">
                        <input class="file-path validate" type="text" name="txtlogo">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="input-field col s12">
                    ...
                    <textarea name="txtdescripcion" class="materialize-textarea"></textarea>
                  </div>
                  <div class="input-field col s12">
                    <label>Entrenamientos</label>
                    <textarea name="txtentrenamientos" class="materialize-textarea"></textarea>
                  </div>
                  <div class="input-field col s6">
                    <label>WEB</label>
                    <input type="text" name="txtweb" required="required" class="validate">
                  </div>
                  <div class="input-field col s6">
                    <label>Redes Sociales</label><br><br>
                    <input name="txtfacebook" type="text" placeholder="Ingrese su cuenta de Facebook" /><br>
                    <input name="txtinstagram" type="text" placeholder="Ingrese su cuenta de Instagram"/><br>
                    <input name="txttwitter" type="text" placeholder="Ingrese su cuenta de Twittera" /> <br>
                  </div>
