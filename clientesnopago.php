<?php
  ...
  $sql="CALL LISTA_CLIENTES_NO_PAGOS";
                    ...
                    <li class="bold"><a class="collapsible-header  waves-effect waves-red active"><i class="mdi-action-account-circle"></i> Clientes</a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active"><a href="clientesnopago.php">Clientes no Pagos </a>
                                </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">CLIENTES NO PAGOS</h5>
                <ol class="breadcrumbs">
                    <li><a href="clientespago.php"></a>Clientes</li>
                    <li class="active">Clientes no Pago</li>
                </ol>
              </div>
            </div>
          </div>
