...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Resultados pagina _PAGE_de _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Resultados _START_ a _END_ de _TOTAL_ entradas",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Resultados 0 a 0 de 0 entradas",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "loadingRecords": "Por favor esperar - cargando..."
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "processing": "DataTables está ocupado actualmente"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "search": "Aplicar dlitros _INPUT_ a tabla"
			 *        }
			 *      } );
			 *    } );
			 */
