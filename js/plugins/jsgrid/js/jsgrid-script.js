$(function() {
            ...
            $("#jsGrid-basic").jsGrid({
                ...
                pageSize: 15,
                pageButtonCount: 5,
                deleteConfirm: "¿Seguro quieres eliminar el cliente?",
                controller: db,
                fields: [
                    { name: "Nombres", type: "text", width: 150 },
                    { name: "Edad", type: "number", width: 50 },
                    { name: "Dirección", type: "text", width: 200 },
                    { name: "Ciudad", type: "select", items: db.countries, valueField: "Id", textField: "Name" },
