$(function() {
            ...
            $("#jsGrid-static").jsGrid({
                ...
                fields: [
                    ...
                    { name: "Country", type: "select", items: dbfit.countries, valueField: "Id", textField: "Name" },
            ...
            $("#jsGrid-basic").jsGrid({
                ...
                pageSize: 15,
                pageButtonCount: 5,
                deleteConfirm: "¿De verdad quieres eliminar el cliente?",
                controller: dbfit,
                fields: [
                    { name: "Nombres y Apellidos", type: "text", width: 150 },
                    { name: "Edad", type: "number", width: 50 },
                    { name: "Direccion", type: "text", width: 200 },
                    { name: "Ciudad", type: "select", items: dbfit.countries, valueField: "Id", textField: "Name" },
            ...
            $("#jsGrid-page").jsGrid({
                ...
                controller: {
                    loadData: function(filter) {
                        ...
                        return {
                            data: dbfit.clients.slice(startIndex, startIndex + filter.pageSize),
                            itemsCount: dbfit.clients.length
                        };
                    }
                },
                fields: [
