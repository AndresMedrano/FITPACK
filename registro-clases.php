      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Clases</h5>
                <ol class="breadcrumbs">
                    <li><a href="clientes.php"></a>Clases</li>
                    <li class="active">Crear una Nueva Clase</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="card-panel">
            <div class="row">
              <div class="col s12">
                  <form id="clases" name="frmclientes" method="POST" action="carga-registro-clase.php" enctype="multipart/form-data">
                  <h5><font color="#b71c1c">Datos de la Clase</font></h5>  
                  <div class="input-field col s4">
                    <label class="active" for="Nombres">Gimnasio</label>
                    <select name="gimnasio" class="validate">
                      <option value="" disabled selected="" >Seleccione Gimnasio</option>
                      <option value="Quito">Quito</option>
                      <option value="Cumbay&aacute;">Cumbay&aacute;</option>
                    </select>
                  </div>
                  <div class="input-field col s4">
                    <label>Clase</label>
                    <input type="text" name="txtclase" required="required" maxlength="60" class="validate" pattern="[a-zA-Z]*">
                  </div>
                  <div class="input-field col s4">
                    <label>Fecha de la Clase</label>
                    <input type="date" name="txtfecha" required="required" class="datepicker">
                  </div>
                  <div class="input-field col s1">
                  <label>Horario</label>
                  </div>
                  <div class="input-field col s2">
                    <input type="time" data-default="07:00:00" max="22:00:00" min="07:00:00" step="1" name="txtdesde" required="required" class="timepicker">
                  </div>
                  <div class="input-field col s2">
                    <input type="time" data-default="07:00:00" max="22:00:00" min="07:00:00" step="1" name="txthasta" required="required" class="timepicker">
                  </div>
                  <div class="input-field col s4">
